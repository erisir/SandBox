...
public class TrackFileManager {
	...
	public TrackFileManager(Context context,TencentMap map){
		mContent = context;
		tencentMap = map;
	...
	public void addPolyLine() {//透明度0-100，色调0-1，饱和度0-1，亮度0-1
		Polyline polyline = tencentMap.addPolyline(new PolylineOptions().addAll(latLngs).color(Color.HSVToColor(60,new float[]{(float) (0.7), 1f, 1f})).arrow(true).width(9f));
