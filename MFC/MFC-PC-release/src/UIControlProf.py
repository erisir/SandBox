...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.PID_Inteval.setSingleStep(100.0)
        self.PID_Inteval.setProperty("value", 2000.0)
        ...
        self.PID_VotageChanel.setDecimals(3)
        self.PID_VotageChanel.setMaximum(100.0)
        ...
        self.Prescaler.setMaximum(65535.0)
        self.Prescaler.setProperty("value", 0.0)
